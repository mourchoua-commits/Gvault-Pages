...
window.GVAULT_CONTROL_TOWER_ARCHITECTURE_V5=Object.freeze({
  ...
  advancedCapabilities:Object.freeze(['QRSPRITE_CHROMA','TWITCH_DEPLOY','WORLD_IMAGE_EMBED','ACOUSTIC_PERCEPTION','VISUAL_PERCEPTION','SOLAR_DAY_NIGHT_SOUND_SIMULATION','ACCORD_CADUC_REACTION','CONSEQUENCE_FLUX','PUBLIC_GIT_CHANGELOG_INTAKE','NON_BLOB_GUARD']),
  getState:()=>({
