...
assert.ok(emitted.length>=14);
assert.equal(out.blobs.length,emitted.length);
assert.ok(out.blobs.some(b=>b.type==='action.pass'&&b.payload.action==='banana.verify'));
