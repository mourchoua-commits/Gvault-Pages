...
(()=>{'use strict';
if(window.GTHINK_LOCAL_IMAGE_RENDERER||document.querySelector('script[data-gthink-local-image-renderer]'))return;
const current=document.currentScript?.src||location.href;
const script=document.createElement('script');
script.src=new URL('gthink-local-image-renderer.js?v=1',current).href;
script.dataset.gthinkLocalImageRenderer='V1';
script.async=false;
document.head.appendChild(script);
})();
(()=>{'use strict';
if(document.querySelector('script[data-gthink-five-blob-burst]'))return;
const current=document.currentScript?.src||location.href;
const script=document.createElement('script');
script.src=new URL('gthink-five-blob-burst.js?v=1',current).href;
script.dataset.gthinkFiveBlobBurst='V1';
script.async=false;
document.head.appendChild(script);
})();