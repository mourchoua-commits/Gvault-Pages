...
const core={
  schema:'GVAULT_PUBLIC_SCOUT_LATEST_V1',version:1,status:'PASS',requestId:translated.requestId,topic:translated.topic,sourceUrl:translated.sourceUrl,scanSourceIndex:translated.scanSourceIndex??null,scanAttemptCount:translated.scanAttemptCount??null,sourceBodySha256:sourceDigest,translationDigest,publishedAt,integrity:{state:'PASS',rawBodyPublished:false,privateCredentialRequired:false,translatorNetworkUsed:false},rangers:{black:{color:'BLACK',phase:'SCAN',signal:blackSignal,message:blackMessage},white:{color:'WHITE',phase:'TRANSLATE',signal:whiteSignal,message:whiteMessage},publisher:{color:'WHITE',phase:'PUBLISH',signal:publishSignal,message:publishMessage}},observerEvents,privateAckHint:{authority:'PUBLIC_ACK_REFERENCES_EXACT_DATA_COMMIT',translationDigest,sourceBodySha256:sourceDigest}
};
