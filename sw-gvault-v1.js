const VERSION='gvault-shell-v1-20260902-gthink-page-prelistener-v3';
...
const isGThinkCritical=url=>url.origin===scopeOrigin&&/(?:^|\/)(?:gvault-agent-live-blob|gthink-public-private-bridge|gthink-page-prelistener-mesh|gthink-client-private-worker|gthink-mini-listener-swarm|gthink-prelistener-stream-blob|gthink-throughput-guard|gthink-public-responder|gthink-turn-relay|gvault-person-blob)\.js$/i.test(url.pathname);
